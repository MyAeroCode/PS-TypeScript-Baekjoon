function solution(io: NodeIO): void {
    ...
    const codes = makeArray(Int8Array, line.length, (i) => line.charCodeAt(i));
    const stack = new FixedArrayAdaptor(Int8Array, line.length);
    //
    //
    function isPPAP(): boolean {
    ...
    io.write(stack.size() === 1 && stack.get(0) === 80 ? "PPAP" : "NP");
}
//
// 입출력 객체
class NodeIO {
